...
try{
 ...
 for(const route of ['/','/revenue.html?demo=1','/live.html?demo=1','/docs/index.html']){
  ...
  await selectLanguage(page,'zh');if(await page.locator('[data-product-theme]').getAttribute('aria-checked')!=='true')await page.locator('[data-product-theme]').click();
  ...
  await selectLanguage(page,'en');if(await page.locator('[data-product-theme]').getAttribute('aria-checked')!=='false')await page.locator('[data-product-theme]').click();
