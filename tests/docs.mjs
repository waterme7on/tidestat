...
test('documentation distinguishes payments, aggregate search and unpublished installation', () => {
  for (const text of ['not a published npm release', 'aggregate imports', 'refund.created', 'refund.updated', 'timelineTruncated', 'allowedOrigins', 'No matching pages']) assert.ok(html.toLowerCase().includes(text.toLowerCase()), text);
